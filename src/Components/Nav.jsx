...
const solutions = [
  {
    name: 'Tic-Tac-Toe-AI',
    description: 'A Tic-Tac-Toe game with a unbeatable AI powered with the minimax algorithim.',
    href: 'https://jdeghelshi95.github.io/tic-tac-toe/',
    icon: HashtagIcon,
  },
  {
    name: 'Engagement',
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-5 sm:px-6 sm:py-4 md:justify-start md:space-x-10 lg:px-8">
          <div>
            <a href="#" className="flex">
              <span className="sr-only">Joshua Eghelshi Portfolio</span>
              <img
          ...
          <div className="-my-2 -mr-2 md:hidden">
            <Popover.Button className="inline-flex items-center justify-center rounded-md bg-white p-2 text-white hover:bg-gray-100 hover:text-red-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        ...
                        'group inline-flex items-center rounded-md bg-gray-700 text-base font-medium hover:text-red-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2'
                      )}
                    >
                      <span>Projects</span>
                      <ChevronDownIcon
                        className={classNames(
                          ...
                          'ml-2 h-5 py-2 w-5   group-hover:text-red-600'
                        )}
                        aria-hidden="true"
                      />
                    </Popover.Button>
                    ...
                    >
                      <Popover.Panel className="absolute inset-x-0 top-full z-10 hidden transform bg-gray-500 shadow-lg md:block">
                          ...
                          <div className="mx-auto max-w-7xl space-y-6 px-4 py-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-6 lg:px-8">
                            {callsToAction.map((item) => (
                              <div key={item.name} className="flow-root">
                                <a
                                  href={item.href}
                                  className="-m-3 flex items-center rounded-md p-3 text-base font-medium text-white hover:bg-red-700"
                                >
