        ...
        <div className=" ">
         ...
         <div className="w-full h-1/6 flex justify-center mt-6">     
          ...
          <div className=" w-1/2 h-full    text-white">
            ...
            <h2 className=" h-fit self-center text-2xl font-mono  "> Software Engineer</h2>
            </div>
            <div className="w-full">
            <h1 className=" h-fit self-center text-2xl font-mono  "> Joshua Eghelshi</h1>
            </div>
            </div>
